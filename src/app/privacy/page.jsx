...
const page = () => {
  return (
    <div>
      ...
      >
        <div className="p-2 sm:p-10 rounded-lg text-center">
      ...
      <div className="bg-white py-3 sm:py-10">
        <div className="max-w-4xl mx-auto p-3 sm:p-8 bg-white">
          <h2 className="text-xl sm:text-3xl font-bold mb-6">Privacy Policy</h2>
          <p className="mb-6">
          ...
          <h3 className="text-lg sm:text-2xl font-semibold mb-4">Changes</h3>
          <p className="mb-6">
